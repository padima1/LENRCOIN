...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xa77e1;//adresses start with"enr"
...
const char     CRYPTONOTE_NAME[]                             = "LENRCOIN";
...
const int      RPC_DEFAULT_PORT                              = 18600;
